...
-- Passage en erreur interne
UPDATE edp.type_erreur set code = 'I1008' where code = '1008';

INSERT INTO edp.type_erreur(code, iterations, contexte, message_action, message_erreur) VALUES
('1008', 1, 'EDP_METIER', 'La valeur de modèle renseignée par EDP existe dans REMOCRA, mais n''est pas liée à la marque à laquelle de PEI est rattaché', 'Modifier la valeur dans WatGIS');