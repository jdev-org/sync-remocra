  ...
  messageRecord_erreur = null;
	...
	ELSE
		...
		IF (remotePei.date_maj_e > derniereRemontee) THEN
		  ...
		  (tracaPeiId, remotePei.date_maj_e, 'INDISPO_TEMPORAIRE', messageRecord_statut, messageRecord_erreur, messageRecord_synchroniser) RETURNING id into messageRecordId;
		END IF;
      ...
      INSERT INTO edp.message(id_traca_pei, date, type) VALUES
      (tracaPeiId, remotePei.date_maj_mj, 'MANUELLE');
    END IF;
