...
('BSPP_APDP', 'APP A RENOUVELER'),
('BSPP_APDP', 'APP A REPARER'),
('BSPP_APSE', 'APP SANS EAU'),
('BSPP_APSE', 'APP SIGNALE'),
('BSPP_APSE', 'FERME DEMANDE TIERS'),
('BSPP_APSE', 'SANS CONDUITE'),
('BSPP_APSE', 'ARRET EAU'),
('BSPP_APSE', 'PUISAGE'),
('BSPP_APSE', 'FERMETURE HIVERNALE'),
('BSPP_APSE', 'EDP_INDISPO'),
('BSPP_STPO', 'STREETPOOLING'),
('BSPP_APEN', 'APP SUR CHANTIER'),
('BSPP_INTE', 'INACCESSIBLE');

INSERT INTO edp.type_erreur(code, iterations, contexte, message_action, message_erreur) VALUES
('I1002', 1, 'EDP_METIER', 'Veuillez vérifier que tous les PEI de la base Watgis ont bien une référence attribuée',
 'Un changement a été détecté sur un PEI n''ayant pas de référence permettant de l''identifier dans la base REMOCRA');
