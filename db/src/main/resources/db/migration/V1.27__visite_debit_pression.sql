...
ADD COLUMN date_essai TIMESTAMP WITHOUT TIME ZONE,
ADD COLUMN essai_pression_statique NUMERIC(8,2),
ADD COLUMN essai_pression_dynamique NUMERIC(8,2),
ADD COLUMN essai_debit NUMERIC(8,2),
ADD COLUMN date_maj_qp TIMESTAMP WITHOUT TIME ZONE;
...
BEGIN
  ...
  FOR remotePei IN (SELECT gid_edp, reference, type_objet, prive, precision_pei_prive, adresse, notes_localisation, diametre, modele,
	diametre_canalisation, etat, date_essai, essai_pression_statique, essai_pression_dynamique, essai_debit, date_maj_p, date_maj_e, date_maj_qp
	...
	ELSE
		...
		INSERT INTO edp.tracabilite_pei(reference, geometry1, type_objet,
		  ...
		  essai_debit, date_maj_p, date_maj_e, date_maj_qp, date_traca) VALUES
		(remotePei.reference, NULL, remotePei.type_objet, remotePei.prive,
		 ...
		 remotePei.essai_pression_dynamique, remotePei.essai_debit, remotePei.date_maj_p,
		 remotePei.date_maj_e, remotePei.date_maj_qp, current_execution) RETURNING id INTO tracaPeiId;
...
END
$BODY$;
ALTER FUNCTION edp.changedatacapture() OWNER TO edp;