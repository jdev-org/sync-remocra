...
public class ReferentielAnomalies extends TableImpl<ReferentielAnomaliesRecord> {
     ...
     */
    public final TableField<ReferentielAnomaliesRecord, String> CODE_BSPP = createField(DSL.name("code_bspp"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>edp.referentiel_anomalies.code_edp</code>.
     */
    public final TableField<ReferentielAnomaliesRecord, String> CODE_EDP = createField(DSL.name("code_edp"), SQLDataType.VARCHAR.nullable(false), this, "");

    private ReferentielAnomalies(Name alias, Table<ReferentielAnomaliesRecord> aliased) {
        this(alias, aliased, null);
    }

    private ReferentielAnomalies(Name alias, Table<ReferentielAnomaliesRecord> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> ReferentielAnomalies(Table<O> child, ForeignKey<O, ReferentielAnomaliesRecord> key) {
