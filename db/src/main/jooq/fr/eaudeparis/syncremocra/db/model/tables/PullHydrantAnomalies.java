...
public class PullHydrantAnomalies extends TableImpl<PullHydrantAnomaliesRecord> {
     ...
     */
    public final TableField<PullHydrantAnomaliesRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>edp.pull_hydrant_anomalies.visite</code>.
     */
    public final TableField<PullHydrantAnomaliesRecord, Long> VISITE = createField(DSL.name("visite"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>edp.pull_hydrant_anomalies.code</code>.
     */
    public final TableField<PullHydrantAnomaliesRecord, String> CODE = createField(DSL.name("code"), SQLDataType.VARCHAR, this, "");

    private PullHydrantAnomalies(Name alias, Table<PullHydrantAnomaliesRecord> aliased) {
        this(alias, aliased, null);
    }

    private PullHydrantAnomalies(Name alias, Table<PullHydrantAnomaliesRecord> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> PullHydrantAnomalies(Table<O> child, ForeignKey<O, PullHydrantAnomaliesRecord> key) {
    ...
    public List<ForeignKey<PullHydrantAnomaliesRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<PullHydrantAnomaliesRecord, ?>>asList(Keys.PULL_HYDRANT_ANOMALIES__FK_VISITE);
    }
