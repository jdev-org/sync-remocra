...
public class PullMessage extends TableImpl<PullMessageRecord> {
     ...
     */
    public final TableField<PullMessageRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>edp.pull_message.date</code>.
     */
    public final TableField<PullMessageRecord, LocalDateTime> DATE = createField(DSL.name("date"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field("now()", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>edp.pull_message.date_modification</code>.
     */
    public final TableField<PullMessageRecord, LocalDateTime> DATE_MODIFICATION = createField(DSL.name("date_modification"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>edp.pull_message.operation</code>.
     */
    public final TableField<PullMessageRecord, String> OPERATION = createField(DSL.name("operation"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>edp.pull_message.type</code>.
     */
    public final TableField<PullMessageRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>edp.pull_message.hydrant</code>.
     */
    public final TableField<PullMessageRecord, String> HYDRANT = createField(DSL.name("hydrant"), SQLDataType.VARCHAR, this, "");
