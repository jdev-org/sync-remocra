...
public class TracabilitePei extends TableImpl<TracabilitePeiRecord> {
  ...
  public final TableField<TracabilitePeiRecord, Integer> ID =
  ...
  public final TableField<TracabilitePeiRecord, String> REFERENCE =
      createField(DSL.name("reference"), SQLDataType.VARCHAR(15), this, "");

  /** The column <code>edp.tracabilite_pei.geometry1</code>. */
  public final TableField<TracabilitePeiRecord, Point> GEOMETRY1 =
      createField(
          DSL.name("geometry1"),
  ...
  public final TableField<TracabilitePeiRecord, BigDecimal> ESSAI_PRESSION_STATIQUE =
  ...
  public final TableField<TracabilitePeiRecord, BigDecimal> ESSAI_PRESSION_DYNAMIQUE =
  ...
  public final TableField<TracabilitePeiRecord, BigDecimal> ESSAI_DEBIT =
      createField(DSL.name("essai_debit"), SQLDataType.NUMERIC(8, 2), this, "");

  /** The column <code>edp.tracabilite_pei.date_maj_qp</code>. */
  public final TableField<TracabilitePeiRecord, LocalDateTime> DATE_MAJ_QP =
  ...
  public final TableField<TracabilitePeiRecord, LocalDateTime> DATE_DERNIERE_VISITE =
  ...
  public final TableField<TracabilitePeiRecord, String> TYPE_DERNIERE_VISITE =
  ...
  public <O extends Record> TracabilitePei(
      Table<O> child, ForeignKey<O, TracabilitePeiRecord> key) {
