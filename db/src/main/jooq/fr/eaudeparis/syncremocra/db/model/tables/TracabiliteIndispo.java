...
public class TracabiliteIndispo extends TableImpl<TracabiliteIndispoRecord> {
     ...
     */
    public final TableField<TracabiliteIndispoRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>edp.tracabilite_indispo.id_traca_pei</code>.
     */
    public final TableField<TracabiliteIndispoRecord, Long> ID_TRACA_PEI = createField(DSL.name("id_traca_pei"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>edp.tracabilite_indispo.reference</code>.
     */
    public final TableField<TracabiliteIndispoRecord, String> REFERENCE = createField(DSL.name("reference"), SQLDataType.VARCHAR(15), this, "");

    /**
     * The column <code>edp.tracabilite_indispo.motif_indispo</code>.
     */
    public final TableField<TracabiliteIndispoRecord, String> MOTIF_INDISPO = createField(DSL.name("motif_indispo"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>edp.tracabilite_indispo.date_debut</code>.
     */
    public final TableField<TracabiliteIndispoRecord, LocalDateTime> DATE_DEBUT = createField(DSL.name("date_debut"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>edp.tracabilite_indispo.date_fin_prevue</code>.
     */
    public final TableField<TracabiliteIndispoRecord, LocalDateTime> DATE_FIN_PREVUE = createField(DSL.name("date_fin_prevue"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>edp.tracabilite_indispo.date_traca</code>.
     */
    public final TableField<TracabiliteIndispoRecord, LocalDateTime> DATE_TRACA = createField(DSL.name("date_traca"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>edp.tracabilite_indispo.statut_motif_indispo</code>.
     */
    public final TableField<TracabiliteIndispoRecord, String> STATUT_MOTIF_INDISPO = createField(DSL.name("statut_motif_indispo"), SQLDataType.VARCHAR(15), this, "");

    private TracabiliteIndispo(Name alias, Table<TracabiliteIndispoRecord> aliased) {
        this(alias, aliased, null);
    }

    private TracabiliteIndispo(Name alias, Table<TracabiliteIndispoRecord> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> TracabiliteIndispo(Table<O> child, ForeignKey<O, TracabiliteIndispoRecord> key) {
    ...
    public List<ForeignKey<TracabiliteIndispoRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<TracabiliteIndispoRecord, ?>>asList(Keys.TRACABILITE_INDISPO__FK_ID_TRACA_PEI);
    }
