...
public class PullHydrantVisite extends TableImpl<PullHydrantVisiteRecord> {
  ...
  public final TableField<PullHydrantVisiteRecord, Integer> ID =
  ...
  public final TableField<PullHydrantVisiteRecord, Long> HYDRANT =
      createField(DSL.name("hydrant"), SQLDataType.BIGINT, this, "");

  /** The column <code>edp.pull_hydrant_visite.date</code>. */
  public final TableField<PullHydrantVisiteRecord, LocalDateTime> DATE =
      createField(DSL.name("date"), SQLDataType.LOCALDATETIME(6), this, "");

  /** The column <code>edp.pull_hydrant_visite.type</code>. */
  public final TableField<PullHydrantVisiteRecord, String> TYPE =
      createField(DSL.name("type"), SQLDataType.VARCHAR, this, "");

  /** The column <code>edp.pull_hydrant_visite.ctrl_debit_pression</code>. */
  public final TableField<PullHydrantVisiteRecord, Boolean> CTRL_DEBIT_PRESSION =
      createField(DSL.name("ctrl_debit_pression"), SQLDataType.BOOLEAN, this, "");

  /** The column <code>edp.pull_hydrant_visite.agent1</code>. */
  public final TableField<PullHydrantVisiteRecord, String> AGENT1 =
      createField(DSL.name("agent1"), SQLDataType.VARCHAR, this, "");

  /** The column <code>edp.pull_hydrant_visite.agent2</code>. */
  public final TableField<PullHydrantVisiteRecord, String> AGENT2 =
      createField(DSL.name("agent2"), SQLDataType.VARCHAR, this, "");

  /** The column <code>edp.pull_hydrant_visite.debit</code>. */
  public final TableField<PullHydrantVisiteRecord, Integer> DEBIT =
      createField(DSL.name("debit"), SQLDataType.INTEGER, this, "");

  /** The column <code>edp.pull_hydrant_visite.debit_max</code>. */
  public final TableField<PullHydrantVisiteRecord, Integer> DEBIT_MAX =
      createField(DSL.name("debit_max"), SQLDataType.INTEGER, this, "");

  /** The column <code>edp.pull_hydrant_visite.pression</code>. */
  public final TableField<PullHydrantVisiteRecord, Double> PRESSION =
      createField(DSL.name("pression"), SQLDataType.DOUBLE, this, "");

  /** The column <code>edp.pull_hydrant_visite.pression_dyn</code>. */
  public final TableField<PullHydrantVisiteRecord, Double> PRESSION_DYN =
      createField(DSL.name("pression_dyn"), SQLDataType.DOUBLE, this, "");

  /** The column <code>edp.pull_hydrant_visite.pression_dyn_deb</code>. */
  public final TableField<PullHydrantVisiteRecord, Double> PRESSION_DYN_DEB =
      createField(DSL.name("pression_dyn_deb"), SQLDataType.DOUBLE, this, "");

  /** The column <code>edp.pull_hydrant_visite.observations</code>. */
  public final TableField<PullHydrantVisiteRecord, String> OBSERVATIONS =
      createField(DSL.name("observations"), SQLDataType.VARCHAR, this, "");

  private PullHydrantVisite(Name alias, Table<PullHydrantVisiteRecord> aliased) {
    this(alias, aliased, null);
  }

  private PullHydrantVisite(
      Name alias, Table<PullHydrantVisiteRecord> aliased, Field<?>[] parameters) {
  ...
  public <O extends Record> PullHydrantVisite(
      Table<O> child, ForeignKey<O, PullHydrantVisiteRecord> key) {
  ...
  public List<ForeignKey<PullHydrantVisiteRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<PullHydrantVisiteRecord, ?>>asList(
        Keys.PULL_HYDRANT_VISITE__FK_HYDRANT);
  }
