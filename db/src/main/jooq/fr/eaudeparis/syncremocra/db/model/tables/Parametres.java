...
public class Parametres extends TableImpl<ParametresRecord> {
     ...
     */
    public final TableField<ParametresRecord, String> CODE = createField(DSL.name("code"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>edp.parametres.valeur</code>.
     */
    public final TableField<ParametresRecord, String> VALEUR = createField(DSL.name("valeur"), SQLDataType.VARCHAR, this, "");
