...
public class VueVisite extends TableImpl<VueVisiteRecord> {
     ...
     */
    public final TableField<VueVisiteRecord, Integer> GID_EDP = createField(DSL.name("gid_edp"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>edp.vue_visite.reference</code>.
     */
    public final TableField<VueVisiteRecord, String> REFERENCE = createField(DSL.name("reference"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>edp.vue_visite.date_visite</code>.
     */
    public final TableField<VueVisiteRecord, LocalDateTime> DATE_VISITE = createField(DSL.name("date_visite"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>edp.vue_visite.type_visite</code>.
     */
    public final TableField<VueVisiteRecord, String> TYPE_VISITE = createField(DSL.name("type_visite"), SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>edp.vue_visite.essaie_pression_static</code>.
     */
    public final TableField<VueVisiteRecord, Integer> ESSAIE_PRESSION_STATIC = createField(DSL.name("essaie_pression_static"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>edp.vue_visite.essaie_pression_dynamique</code>.
     */
    public final TableField<VueVisiteRecord, Integer> ESSAIE_PRESSION_DYNAMIQUE = createField(DSL.name("essaie_pression_dynamique"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>edp.vue_visite.essaie_debit</code>.
     */
    public final TableField<VueVisiteRecord, Integer> ESSAIE_DEBIT = createField(DSL.name("essaie_debit"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>edp.vue_visite.date_maj_e</code>.
     */
    public final TableField<VueVisiteRecord, LocalDateTime> DATE_MAJ_E = createField(DSL.name("date_maj_e"), SQLDataType.LOCALDATETIME(6), this, "");
