...
- `API_AUTH_TYPE=legacy-jwt` avec `API_MAIL` / `API_PASSWORD`
- ou `API_AUTH_TYPE=keycloak` avec `API_KEYCLOAK_URL`, `API_KEYCLOAK_REALM`,
  `API_KEYCLOAK_CLIENT_ID` et `API_KEYCLOAK_CLIENT_SECRET`
