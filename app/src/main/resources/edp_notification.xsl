...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<div>
		...
		<p>Le système automatisé de transfert de données entre EDP et REMOCRA n'a pas pu réaliser automatiquement toutes les synchronisations de données. Merci de prendre en charge les actions mentionnées ci-dessous.</p>
...
<xsl:template match="erreur" >
	<tr>
		...
		<td style="width:50%">
			...
			<xsl:if test="*">
				<p>Informations sur la visite</p>
				<ul>
					<li>Type de visite : <xsl:value-of select="donnees/contexteVisite"/></li>
					<li>Date et heure de visite : <xsl:value-of select="donnees/dateHeureVisite"/></li>
